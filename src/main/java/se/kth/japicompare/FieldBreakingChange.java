package se.kth.japicompare;


import japicmp.model.JApiCompatibilityChangeType;
import japicmp.model.JApiField;
import javassist.NotFoundException;
import se.kth.spoon_visitor.*;
        ...
        return
                switch (change) {
                    ...
                    case FIELD_LESS_ACCESSIBLE ->
                            new FieldLessAccessibleVisitor(fRef, jApiField.getAccessModifier().getNewModifier().get());
                    ...
                    default -> {
                        System.out.println("FieldBreakingChange.getVisitor: " + change);
                        yield null;
